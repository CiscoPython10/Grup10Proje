...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////yuztanimlama.db'
db = SQLAlchemy(app)
...
@app.route("/yoklama")
def yoklama():
    yoklama = Yoklama.query.order_by(Yoklama.id).all()#Yoklamam tablosundaki tüm kayıtları al
    return render_template("yoklama.html",yoklama=yoklama[-1::-1])
...
#                 return render_template('cam1.html',id=id+"_"+tahminEdilenKisi)
